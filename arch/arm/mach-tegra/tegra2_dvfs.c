...
static struct dvfs dvfs_cpu[NUM_SPEED_LEVELS][NUM_PROCESS_CORNERS] = {
	...
	{
		CPU_DVFS("cpu", MHZ, 314, 314, 314, 456, 456, 456,  608,  608,  608,  760,  817,  817,  912,  1200),
		CPU_DVFS("cpu", MHZ, 314, 314, 314, 456, 456, 456,  618,  618,  618,  770,  827,  827,  922,  1200),
		CPU_DVFS("cpu", MHZ, 494, 494, 494, 675, 675, 817,  817,  922,  922,  1200),
		CPU_DVFS("cpu", MHZ, 730, 760, 845, 845, 940, 1200),
	},
	{
		CPU_DVFS("cpu", MHZ, 380, 380, 503, 503, 655, 655,  798,  798,  902,  902,  960,  1200),
		CPU_DVFS("cpu", MHZ, 389, 389, 503, 503, 655, 760,  798,  798,  950,  950,  1200),
		CPU_DVFS("cpu", MHZ, 598, 598, 750, 750, 893, 893,  1200),
		CPU_DVFS("cpu", MHZ, 730, 760, 845, 845, 940, 1200),
	},
	{
