...
static int smba1002_wifi_power(int on)
{
	printk(KERN_INFO "smba1002_wifi_power called\n");
        pr_debug("%s: %d\n", __func__, on);
...
static struct tegra_sdhci_platform_data tegra_sdhci_platform_data2 = {
	.cd_gpio = -1, /* SMBA1002_SDHC2_CD,  */
	.wp_gpio = -1,    /*    SMBA1002_SDHC2_WP, */
	.power_gpio = -1, /*SMBA1002_SDHC2_POWER, */
};
...
{
	printk(KERN_INFO "smba1002_wifi_init\n");
...
{
	printk(KERN_INFO "smba1002_sdhci_register_devices\n");
	int ret=0;
